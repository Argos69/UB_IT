...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() и Параметры.Свойство("ПринадлежностьЦели") Тогда
		ЗаполнитьЗначенияСвойств(Объект, Параметры, "Родитель, ПринадлежностьЦели");		
	КонецЕсли;
...
Процедура ПринадлежностьЦелиИзменениеТекстаРедактирования(Элемент, Текст, СтандартнаяОбработка)
	Если Объект.ПринадлежностьЦели = УБ_ОбщегоНазначенияПовтИсп.ЗначениеРеквизитаПоУмолчанию("Компания") Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = "Нельзя изменять значение вручную.";
		Сообщение.Сообщить();		                        
		Объект.ПринадлежностьЦели = УБ_ОбщегоНазначенияПовтИсп.ЗначениеРеквизитаПоУмолчанию("Компания");
