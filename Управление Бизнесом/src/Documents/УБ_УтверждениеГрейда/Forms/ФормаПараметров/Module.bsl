...
Процедура ИзменитьФормулу(Команда)
	...
	Если ЗначениеЗаполнено(ТипПоказателя) Тогда
		...
		СФормироватьСписокФормул(ПараметрыФормы);
		...
		Оповещение = Новый ОписаниеОповещения("ЗафиксироватьФормулыРасчета", ЭтотОбъект, Показатель);
	...
	Иначе
		...
		Оповещение = Новый ОписаниеОповещения("ЗафиксироватьФормулуРасчетаЗавершение", ЭтотОбъект,Показатель);
