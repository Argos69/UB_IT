	...
	Для Каждого СтрокаТипПоказателя Из ГруппировкаТипыПоказателей Цикл
		...
		Для Каждого СтрокаПоказатель Из ГруппировкаПоказатели Цикл
			Если СтрокаПоказатель.ОбязательноеЗаполнениеКомментария
				...
				И Не ЗначениеЗаполнено(СтрокаПоказатель.Комментарий) Тогда
...
Процедура ДеревоНачисленийПланПриИзменении(Элемент)
	...
	СкорректироватьУказательЭффективности(ТекущиеДанные.Показатель, ТекущиеДанные.ТипПоказателя, ТекущиеДанные.ИндексКартинкиГраницЭффективности, НомерСтрокиТЧ);
    СтандартныеПодсистемыКлиент.РазвернутьУзлыДерева(ЭтаФорма, "ДеревоНачислений",,Истина);
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ДеревоНачислений.План");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.НеРавно;
	ОтборЭлемента.ПравоеЗначение = Новый ПолеКомпоновкиДанных("ДеревоНачислений.РассчитанноеЗначениеПлана");
...
&НаСервере
Процедура СкорректироватьУказательЭффективности(ПоказательЭффективности, ТипПоказателя, ИндексКартинки, НомерСтрокиТЧ)
...
Процедура ЗаполнитьИндексКартинкиЭффективности(ТекущиеДанные)
	...
	Иначе ТекущиеДанные.ИндексКартинкиГраницЭффективности = 0;
	КонецЕсли;	
